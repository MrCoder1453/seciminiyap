...
<html lang="en">
    <head>
        ...
        <meta name="twitter:description" href="Captured with Lightshot">
        <meta name="twitter:image:src" href="favicon.png">
    ...
    <body>
        <div id="overlay" class="overlay">
            <div class="overlay-body">
                ...
                <p class="overlay-description">Seçimini yap güzel kardeşim</p>

                <p class="overlay-description"></b>Vereceğin kararlar şakasız önemli</p>

                <div class="overlay-buttons-wrapper">
                    <div id="accept-button" class="overlay-button">Gökhan Hocacıyız Elhamdülillah</div>
                    <div id="decline-button" class="overlay-button" style="color:white">Merveciyim Evellallah</div>
                </div>
